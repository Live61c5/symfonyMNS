 ...
 */
final class Version20240423114053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, genres_id INT DEFAULT NULL, authors_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_CBE5A3316A3B2603 (genres_id), INDEX IDX_CBE5A3316DE2013A (authors_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
